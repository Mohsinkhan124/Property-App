...
class Housedetails3 extends StatefulWidget {
  const Housedetails3({super.key});

  @override
  State<Housedetails3> createState() => _Housedetails3State();
}

class _Housedetails3State extends State<Housedetails3> {
  @override
